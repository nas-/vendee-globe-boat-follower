...
request = (
    b'{"type":1,"data":{"rows":[{"LAT":"-42.8567","LON":"-29.80231","SPEED":"122","COURSE":"82","HEADING":"82",'
...
for boatdata in response:
    ...
    tm = tm - datetime.timedelta(
        minutes=int(boatdata["ELAPSED"]), seconds=tm.second, microseconds=tm.microsecond
    )
...
class Test(TestCase):
    def test_calculate_distance(self):
        self.assertAlmostEqual(
            utils.EarthFunctions.calculate_distance((0, 0), (1, 1)), 84.9079932, 3
        )
        self.assertAlmostEqual(
            utils.EarthFunctions.calculate_distance((2, 3), (4, 5)), 169.6996215, 3
        )
    ...
    def test_great_circle_destination(self):
        ...
        self.assertAlmostEqual(
            utils.EarthFunctions.gcd((-50, 85), 90, 500)[0], -49.28531426597719, 3
        )
        self.assertAlmostEqual(
            utils.EarthFunctions.gcd((-50, 85), 90, 500)[1], 97.82884551047957, 3
        )
    ...
    def test_search_for_duplicate(self):
        ...
        self.assertEqual(
            utils.search_for_duplicate(distances, boatdata, datafile, item)[0],
            {
                "LAT": "-37.87994",
                "LON": "74.88072",
                "SPEED": "133",
